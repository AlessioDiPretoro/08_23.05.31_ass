...
console.log("characters Name ", characters);
...
console.log("eyeColor before Add", eyeColor);
...
console.log("eyeColor after switch", eyeColor);
...
let crewMass = 0;
let _i = 0;
while (_i < starWarsCharacters.length) {
  crewMass = crewMass + parseInt(starWarsCharacters[_i].mass);
  _i++;
}
...
/* ESERCIZIO 7
  Crea uno switch statement per rivelare la tipologia di carico, utilizzando la massa totale, di un'impotetica astronave 
...
console.log("after robot change: ", starWarsCharacters)
...
for (let i = 0; i < femaleCharacters.length; i++){
  for (let _i = 0; _i < characters.length; _i++){
    if (characters[_i] === femaleCharacters[i].name){
      delete characters[_i]

    }
  }
}
console.log("characters without females1", characters)

femaleCharacters.forEach(f => {
...
console.log("characters without females2", characters)

/* --EXTRA-- ESERCIZIO 10
  Crea una funzionalità che prenda un elemento casuale dall'array "starWarsCharacters" e ne stampi in console 
